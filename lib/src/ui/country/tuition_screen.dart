...
import 'package:pika/src/ui/country/custom_coutry.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "You can pay tuition fee for your school",
                  ...
                  country == null
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text("Select school",
                                    style: Theme.of(context).textTheme.bodyText2!.copyWith(
                                        fontWeight: FontWeight.w400, fontSize: 16, color: const Color(0xffA2A0A8))),
                              ),
                              InkWell(
                                focusColor: Colors.transparent,
                                highlightColor: Colors.transparent,
                      ...
                      : Container(
                          height: 56,
                          decoration:
                              BoxDecoration(color: const Color(0xffF9F9FA), borderRadius: BorderRadius.circular(16)),
                          child: Row(
                    ...
                    text: TextSpan(children: <TextSpan>[
                      ...
                      TextSpan(
                          ...
                          style: Theme.of(context).textTheme.bodyText2!.copyWith(
                                ...
                                fontSize: 14,
                                color:
                                    AppTheme.isLightTheme == false ? const Color(0xffA2A0A8) : const Color(0xff15141F),
                              )),
                    ]),
                  ),
