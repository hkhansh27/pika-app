...
import 'package:pika/src/ui/notifications/create_pin_screen.dart';
        ...
        child: Column(
          children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        CardTextField(
                          hintText: "Enter name",
                          color: AppTheme.isLightTheme == false ? const Color(0xff323045) : const Color(0xffF9F9FA),
                          radius: 16,
                          ...
                          children: [
                            Expanded(
                              child: CardTextField(
                                hintText: "MM/yy",
                                color:
                                    AppTheme.isLightTheme == false ? const Color(0xff323045) : const Color(0xffF9F9FA),
                                radius: 16,
                                inputType: TextInputType.number,
                              ),
                            ),
            ...
            InkWell(
              ...
              child: Padding(
                padding:
                    EdgeInsets.only(top: 20, bottom: MediaQuery.of(context).padding.bottom + 14, left: 20, right: 20),
                child: Container(
                  height: 64,
                  width: Get.width,
